...
- Lovelace, Nowosad, and Muenchow (2025) [Book on geographic data with R](https://r.geocompx.org/)  
...
- tuto1 : VECTOR: create points, lines and polygons; map and project spatial objects, calculate distance and areas   
...
**Day 2**  
- lesson2 : Getting GIS datasets, multilayer climate data, vegetation indices?    
- tuto4 : STACK: how to load and manipulate multilayer rasters (e.g. remote sensing), thresholding multi day, and multi spectral   
- tuto5 : COMBINE MULTI-SOURCE DATA - reprojecting rasters, tips and tricks => making grid or commune?    
