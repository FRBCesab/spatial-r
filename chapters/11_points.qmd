...
## mapview
The function [`mapview::mapview()`](https://search.r-project.org/CRAN/refmans/mapview/html/mapView.html) creates easily interactive map. If you want to fine tune your map, have a look at this [tutorial](https://r-spatial.github.io/mapview/articles/mapview_01-basics.html). The function `mapview::mapview()` works well with objects loaded from `terra` or `sf`.
