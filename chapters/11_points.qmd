...
This tutorial explore how to handle **spatial points** in {{< fa brands r-project >}} with `terra` package:
...
From GBIF observation data, we will create a proper spatial object in {{< fa brands r-project >}}. Then we will map the observations.
:::
...
## sf
In `sf`, the function is [`sf::st_write()`](https://search.r-project.org/CRAN/refmans/sf/html/st_write.html).
