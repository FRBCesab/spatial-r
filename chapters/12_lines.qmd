...
1. There was ```r nrow(river)``` lines in the dataset. You can access it with `dim(river)`, `nrow(river)` or just by typing `river` in the console.  
...
This question is addressed by the function [`terra::nearest()`](https://search.r-project.org/CRAN/refmans/terra/html/nearby.html).  
...
3. (Reflexion) How can you explain the large distances?
:::
