...
In `terra`, use the argument `add=TRUE` or the function [`terra::points()`](https://search.r-project.org/CRAN/refmans/terra/html/lines.html) to add points to an existing 
```{r mapterra_line}
plot(
  river,
  y = "length_km",
