...
This tutorial explores how to make a create a regular grid and transform spatial informations into a grid with `terra` package:
...
The dataset is made of observations gathered without proper sampling schemes, and with potentially many biases. For such data, it is recommended to use species occupancy models (e.g. [`spOccupancy`](https://doi.org/10.1111/2041-210X.13897)). 
